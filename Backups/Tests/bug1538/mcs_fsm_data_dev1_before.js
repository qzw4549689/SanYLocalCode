...
var FsmDataForm = (function () {
    ...
    // 设备台数/产品名称（六要素，元数据已必填）：只控禁用，不调 setRequiredLevel（避免与元数据必填冲突）
    // Bug #1540 后随融资需求区同口径：仅融资需求阶段（状态 1）可写
    ...
    function applyStageControl(formContext) {
        ...
        // 设备台数/产品名称（六要素，元数据必填只做禁用控制）：
        // Bug #1540 口径——六要素进入融资立项即锁定，故仅融资需求阶段（状态 1）可写
